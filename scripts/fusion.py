...
class Fusion:
	...
	def fusion(self):
		...
		cmd_vel.linear.x  = bg.AND(10*self.behaviors[1,0],bg.INVOKE(self.behaviors[2,0],self.behaviors[3,0]))
                ...
                '''
                #cmd_vel.linear.x  = self.behaviors[3,0]
                #cmd_vel.angular.z = self.behaviors[3,1]
                ...
                '''
		#cmd_vel.linear.x  =  bg.INVOKE(self.behaviors[2,0],self.behaviors[3,0])
                #cmd_vel.angular.z =  bg.OR(self.behaviors[2,1],self.behaviors[3,1])
